...
def generate_sphere( points, cx, cy, cz, r, step ):
    ...
    for i in range(1,step+1):
      phi = i / step * 2 * math.pi
      for k in range(1,step+1):
        theta = k/step*math.pi
        xcor = r * math.cos(theta)+cx
        ycor = r * math.sin(theta)*math.cos(phi)+cy
        zcor = r * math.sin(theta) * math.sin(phi)+cz
        add_point(m,xcor,ycor,zcor)
    return m
...
def add_sphere( points, cx, cy, cz, r, step ):
    matrix = generate_sphere("lol",cx,cy,cz,r,step)
    points += matrix
...
def generate_torus( points, cx, cy, cz, r0, r1, step ):
    ...
    for i in range(1,step+1):
        phi = i / step * 2 * math.pi
        for k in range(1,step+1):
            theta = k/step*2*math.pi
            xcor = math.cos(phi)*(r0*math.cos(theta)+r1)
            ycor = r0 * math.sin(theta)
            zcor = -1*math.sin(phi)*(r0*math.cos(theta)+r1)
            add_point(m,xcor,ycor,zcor)
    return m
...
def add_torus( points, cx, cy, cz, r0, r1, step ):
    matrix = generate_torus("lol",cx,cy,cz,r0,r1,step)
    points += matrix
